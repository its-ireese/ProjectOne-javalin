...
public class UsersPojo {
	...
	public UsersPojo(int userId, String userName, String userPassword, String userType, String userFirstName, String userLastName, String userAddress, String userContact,  boolean userRemoved){
		super();
		this.userId = userId;
